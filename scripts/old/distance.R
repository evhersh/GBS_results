...
OneMLG.dist <- prevosti.dist(OneMLG.gc)
OneMLG.mat <- as.matrix(OneMLG.dist)
sort(OneMLG.mat["L41-A_2",]) 
sort(OneMLG.mat["L17-A_3",])  
sort(OneMLG.mat["S03-A_2",])
sort(OneMLG.mat["SM-A_2",])
sort(OneMLG.mat["C43-A_1",])
sort(OneMLG.mat["L16-A_2",])
sort(OneMLG.mat["L62-A_5",])
sort(OneMLG.mat["C23-A_3",])
sort(OneMLG.mat["L39-A_2",])
sort(OneMLG.mat["L39-A_4",])
